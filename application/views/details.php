...
<div class="form-group">
    ...
    <input type="text" class="form-control"name="pro_cat_id" id="pro_cat_id" value="<?php echo set_value('pro_cat_id'); ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="pro_couleur" id="couleur" value="<?php echo set_value('pro_couleur'); ?>"placeholder="">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="pro_photo" id="photo" value="<?php echo set_value('pro_photo'); ?>"placeholder="Ex: jpg, png, ...">
...
<div class="form-group">
    ...
    <input type="texte" class="form-control" name="pro_bloque" value="<?php echo set_value('pro_bloque'); ?>"id="bloque">
